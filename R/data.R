...
#'   \item{acrynomName}{Company short name in English e.g aka:("SARCO","SAUDI ARAMCO" ..etc)}
...
#'   \item{companyNameAR}{Full company name in Arabic}
...
#'   \item{tradingNameAr}{Short company name in Arabic}
...
#'   \item{companyNameAR}{Full bond name in Arabic}
